...
<template>
  <div class="terapias-domiciliarias">
    <!-- Hero Section -->
      ...
      <div class="container hero-container">
        <div class="row align-items-center">
          <div class="col-lg-6 hero-content text-start">
            <div class="hero-badge">Rehabilitación Integral</div>
            <h1>Terapias Domiciliarias</h1>
            <p class="hero-subtitle">Equipo multidisciplinario especializado para su recuperación en la comodidad de su
              hogar.</p>
          </div>
          <div class="col-lg-6 hero-image-container text-center">
            <img src="../assets/img/rafiki-1.png" alt="Terapias Domiciliarias" class="img-fluid hero-image">
          </div>
        </div>
      </div>
    </section>
